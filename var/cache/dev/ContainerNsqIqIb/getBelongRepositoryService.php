 ...
 */
class getBelongRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\BelongRepository' shared autowired service.
     *
     * @return \App\Repository\BelongRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BelongRepository.php';

        return $container->privates['App\\Repository\\BelongRepository'] = new \App\Repository\BelongRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
