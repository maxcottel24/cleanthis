 ...
 */
class getTypeOperationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TypeOperationRepository' shared autowired service.
     *
     * @return \App\Repository\TypeOperationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TypeOperationRepository.php';

        return $container->privates['App\\Repository\\TypeOperationRepository'] = new \App\Repository\TypeOperationRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
